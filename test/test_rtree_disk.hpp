...
#include <s1o/spatial_adapters/rtree_disk.hpp>
#include <string>
#include <vector>

#define DATASET_TEST(Class, Test) \
    TEST(RtreeDisk##Class, Test) { \
        const char* dataset_name = "RtreeDisk" #Class#Test ; \
...
namespace test
{
    ...
    typedef s1o::spatial_adapters::rtree_disk<
        params_t,
        coord_sys_t
        > rtree;
