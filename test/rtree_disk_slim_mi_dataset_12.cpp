 ...
 *
 */
DATASET_TEST(MultipleSlot, SecondQueryRangeMetaAllTightIndex2)
...

    {
        ...
        for (int iy = 0; iy < Y; iy++) {
            for (int ix = 0; ix < X; ix++, i++) {
                ...
                stuff[i].value1 = 0;
                stuff[i].value2 = static_cast<char>(i/199 - 100);
            }
        }
    }
    ...
    try {
        ...
        test::value2_index point1(-100);
        test::value2_index point2(101);
 ...
 *
 */
DATASET_TEST(MultipleSlot, SecondQueryRangeMetaOneTightIndex2)
    ...
    try {
        ...
        const size_t Who = 39999;

        test::value2_index point1(stuff[Who].value2);
        test::value2_index point2(stuff[Who].value2);
 ...
 *
 */
DATASET_TEST(MultipleSlot, SecondQueryRangeMetaComplexIndex2)
    ...
    try {
        ...
        test::value2_index point1(17);
        test::value2_index point2(120);
        ...
        for (int i = 0; i < N; i++) {
            ...
            if (found_uids.find(meta.uid) != found_uids.end()) {
                ...
                ASSERT_TRUE(minval <= meta.value2);
                ASSERT_TRUE(maxval >= meta.value2);
            }
            else {

                ASSERT_FALSE(minval <= meta.value2 && \
                             maxval >= meta.value2);
            }
        }
    }
 ...
 *
 */
DATASET_TEST(MultipleSlot, SecondQueryRangeMetaComplexEmptyIndex2)
    ...
    try {
        ...
        test::value2_index point1(102);
        test::value2_index point2(127);
 ...
 *
 */
DATASET_TEST(MultipleSlot, SecondQueryRangeElemAllTightIndex2)
 ...
 *
 */
DATASET_TEST(MultipleSlot, SecondQueryRangeElemOneTightIndex2)
 ...
 *
 */
DATASET_TEST(MultipleSlot, SecondQueryRangeElemComplexIndex2)
 ...
 *
 */
DATASET_TEST(MultipleSlot, SecondQueryRangeElemComplexEmptyIndex2)
 ...
 *
 */
DATASET_TEST(MultipleSlot, SecondQueryRangeElemSlotAllTightIndex2)
 ...
 *
 */
DATASET_TEST(MultipleSlot, SecondQueryRangeElemSlotOneTightIndex2)
 ...
 *
 */
DATASET_TEST(MultipleSlot, SecondQueryRangeElemSlotComplexIndex2)
 ...
 *
 */
DATASET_TEST(MultipleSlot, SecondQueryRangeElemSlotComplexEmptyIndex2)
